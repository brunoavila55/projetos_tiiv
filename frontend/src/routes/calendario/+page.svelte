<script lang="ts">
	...
	async function carregarEventos() {
		...
		try {
			eventos = await apiFetch<EventoItem[]>(`/api/eventos?${params}`);
...
<div class="space-y-6">
	<div class="page-head">
		<div>
			...
			<p class="page-sub">Marcações da equipe. Arraste um evento para mudar o dia. A escala de plantão fica em <a href="/plantao?aba=calendario" class="font-semibold text-accent hover:underline underline-offset-2">Plantão</a>.</p>
		</div>
